...
public enum RedEnvelopeRule {
    DIVIDE_EQUALLY(Messages.RED_ENVELOPE_RULE_DIVIDE_EQUALLY), RANDOM(
            Messages.RED_ENVELOPE_RULE_RANDOM), FIRST_COME_GET_MORE(Messages.RED_ENVELOPE_RULE_FIRST_COME_GET_MORE);
    ...
    public static RedEnvelopeRule byId(Integer id) {
        if (id == null) {
            return null;
        }
